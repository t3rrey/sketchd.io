...
export const drawTriangleShape = (canvas: Canvas) => {
...
export const drawRectangleShape = (canvas: Canvas) => {
...
export const drawCircleShape = (canvas: Canvas) => {
  ...
  canvas.centerObject(newCircle);
};

export const drawPolygonShape = (canvas: Canvas) => {
